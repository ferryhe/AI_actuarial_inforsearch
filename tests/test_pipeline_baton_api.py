...
def test_pipeline_baton_api_uses_runtime_bridge_and_existing_permissions(
    ...
    app.state.pipeline_baton_configure = (
        lambda overrides: calls.append(("config", overrides)) or view
    )
