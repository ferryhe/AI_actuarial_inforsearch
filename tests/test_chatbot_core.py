...
class TestConversationManager(unittest.TestCase):
    ...
    def test_create_conversation(self):
        ...
        conv_id = self.manager.create_conversation(
            user_id="test_user", kb_id="test_kb", mode="expert"
        )
    ...
    def test_create_conversation_invalid_mode(self):
        ...
        with self.assertRaises(ConversationException) as ctx:
            self.manager.create_conversation(user_id="test_user", mode="invalid_mode")
    ...
    def test_create_conversation_with_metadata(self):
        ...
        conv_id = self.manager.create_conversation(user_id="test_user", metadata=metadata)
    ...
    def test_add_message(self):
        ...
        msg_id = self.manager.add_message(
            conversation_id=conv_id, role="user", content="What is Solvency II?"
        )
    ...
    def test_add_message_invalid_role(self):
        ...
        with self.assertRaises(ConversationException) as ctx:
            self.manager.add_message(conversation_id=conv_id, role="invalid_role", content="test")
    ...
    def test_add_message_nonexistent_conversation(self):
        ...
        with self.assertRaises(ConversationException) as ctx:
            self.manager.add_message(conversation_id="nonexistent", role="user", content="test")
    ...
    def test_add_message_with_citations(self):
        ...
        citations = [{"filename": "test.pdf", "kb_id": "test_kb", "similarity_score": 0.9}]

        msg_id = self.manager.add_message(
            conversation_id=conv_id, role="assistant", content="Response...", citations=citations
        )
...
class TestQueryRouter(unittest.TestCase):
    ...
    def test_uses_storage_when_loading_default_config(self):
        ...
        with (
            ...
            patch("ai_actuarial.chatbot.router.KnowledgeBaseManager"),
        ):
...
class TestDefaultStoragePropagation(unittest.TestCase):
    ...
    def test_retriever_uses_storage_when_loading_default_config(self):
        with (
            ...
            patch("ai_actuarial.chatbot.retrieval.KnowledgeBaseManager"),
            patch("ai_actuarial.chatbot.retrieval.EmbeddingGenerator"),
        ):
