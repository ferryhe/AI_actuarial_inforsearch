...
(function (global) {
    ...
    const translations = {
        en: {
            ...
            'login.security_note': 'Security note: tokens grant the permissions of the assigned group. Do not share tokens, and rotate them if exposed.',

            // Email Login page
            'el.title':           'Sign In',
            'el.subtitle':        'Access your account',
            'el.email':           'Email Address',
            'el.email_ph':        'you@example.com',
            'el.password':        'Password',
            'el.password_ph':     'Enter password',
            'el.submit':          'Sign In',
            'el.create_account':  'Create Account',
            'el.token_login':     'Token Login',

            // Register page
            'reg.title':          'Create Account',
            'reg.subtitle':       'Register for free access',
            'reg.email':          'Email Address',
            'reg.email_ph':       'you@example.com',
            'reg.display_name':   'Display Name (optional)',
            'reg.name_ph':        'Your name',
            'reg.password':       'Password',
            'reg.password_hint':  '(min 8 characters)',
            'reg.password_ph':    'Enter password',
            'reg.submit':         'Create Account',
            'reg.sign_in':        'Sign In',
            'reg.free_includes':  'Free registered account includes:',
            'reg.free_chat':      'AI Chat: 5 queries/day',
            'reg.free_kb':        'Access to Knowledge Base viewer',
            'reg.free_db':        'Full database browsing',
            'reg.view_upgrade':   'View upgrade options \u2192',
            ...
            'prof.quota_title':      'AI Chat Quota',
            'prof.queries_remaining':'queries remaining today',
            'prof.upgrade_btn':      '\u2191 Upgrade for 100/day',
            'prof.recent_activity':  'Recent Activity',
            'prof.no_activity':      'No recent activity.',
            'prof.token_account':    'Token Account',
            'prof.subject':          'Subject:',
            'prof.group':            'Group:',

            // Upgrade page
            'upg.title':                 'Membership Plans',
            'upg.subtitle':              'Choose the plan that fits your needs. Upgrade anytime to unlock more AI queries and advanced features.',
            'upg.free':                  'Free',
            'upg.per_month':             '/ month',
            'upg.feat_homepage':         'View homepage & database',
            'upg.feat_file_detail':      'File detail view',
            'upg.feat_chat_5':           'AI Chat: 5 queries/day',
            'upg.feat_kb_viewer':        'Knowledge Base viewer',
            'upg.feat_no_task':          'Task management',
            'upg.feat_no_upload':        'File upload & edit',
            'upg.feat_no_priority':      'Priority support',
            'upg.get_started':           'Get Started Free',
            'upg.current_plan':          'Current Plan',
            'upg.most_popular':          'Most Popular',
            'upg.premium':               'Premium',
            'upg.feat_everything_free':  'Everything in Free',
            'upg.feat_chat_100':         'AI Chat: 100 queries/day',
            'upg.feat_full_kb':          'Full Knowledge Base access',
            'upg.feat_download':         'Download files',
            'upg.feat_priority':         'Priority support',
            'upg.feat_no_config':        'System configuration',
            'upg.upgrade_premium':       'Upgrade to Premium',
            'upg.enterprise':            'Enterprise',
            'upg.custom_price':          'Custom',
            'upg.feat_everything_premium':'Everything in Premium',
            'upg.feat_operator':         'Operator access (task management)',
            'upg.feat_upload_config':    'File upload & configuration',
            'upg.feat_dedicated':        'Dedicated support',
            'upg.feat_custom_quota':     'Custom quota limits',
            'upg.feat_audit_logs':       'Audit logs access',
            'upg.contact_us':            'Contact Us',
            'upg.contact_note':          'To upgrade, contact your administrator or send an email. Admins can change your role in the User Management panel.',

            // User Management page
            'um.title':               'User Management',
            'um.search_ph':           'Search email / name…',
            'um.all_roles':           'All Roles',
            'um.filter':              'Filter',
            'um.reset':               'Reset',
            'um.col_id':              'ID',
            'um.col_email':           'Email',
            'um.col_name':            'Name',
            'um.col_role':            'Role',
            'um.col_status':          'Status',
            'um.col_joined':          'Joined',
            'um.col_last_login':      'Last Login',
            'um.col_actions':         'Actions',
            'um.active':              'Active',
            'um.disabled':            'Disabled',
            'um.btn_role':            'Role',
            'um.btn_reset_quota':     'Reset Quota',
            'um.btn_disable':         'Disable',
            'um.btn_enable':          'Enable',
            'um.btn_log':             'Log',
            'um.no_users':            'No users found.',
            'um.user_found':          '1 user found',
            'um.users_found':         '{n} users found',
            'um.change_role':         'Change Role',
            'um.save':                'Save',
            'um.cancel':              'Cancel',
            'um.close':               'Close',
            'um.activity_log':        'Activity Log',
            'um.activity_for':        'Activity: {email}',
            'um.loading':             'Loading…',
            'um.no_activity':         'No activity recorded.',
            'um.activity_load_fail':  'Failed to load activity.',
            'um.confirm_reset_quota': 'Reset AI chat quota for this user for today?',
            'um.quota_reset_ok':      'Quota reset successfully.',
            'um.confirm_toggle_active': 'Are you sure you want to {action} this user?',
            'um.error_prefix':        'Error: ',
            'um.request_failed':      'Request failed: ',
            ...
            'cp.model_auto_inherit': 'Token model fixed to gpt-4 for token counting only (must be OpenAI-compatible)',
            ...
            'tasks.catalog_ai_config_info': 'AI model set in Settings → AI Config',
            ...
            'fv.output_language': 'Output Language',
            'fv.lang_auto':      'Auto (match document language)',
            'fv.lang_en':        'English',
            'fv.lang_zh':        'Chinese (中文)',
            'fv.fh_output_language': 'Language for generated summary, keywords, and suggested title.',
            'fv.update_title':   'Update file title with AI-suggested title',
            'fv.fh_update_title': 'When checked, the file title will be replaced by the AI-generated suggested title after cataloging.',
            ...
            'fv.catalog_ai_config_info': 'AI model set in Settings → AI Config',
            ...
            'tasks.output_language':   'Output Language',
            'tasks.lang_auto':         'Auto (match document language)',
            'tasks.lang_en':           'English',
            'tasks.lang_zh':           'Chinese (中文)',
            'tasks.fh_output_language': 'Language for generated summary, keywords, and suggested title.',
            'tasks.update_title':      'Update file title with AI-suggested title',
            'tasks.fh_update_title':   'When checked, the file title will be replaced by the AI-generated suggested title after cataloging.',
        ...
        zh: {
            ...
            'login.security_note': '安全提示：令牌授予所分配组的权限。请勿分享令牌，如果泄露请立即轮换。',
            ...
            'el.password_ph':     '输入密码',
            'el.submit':          '登录',
            'el.create_account':  '创建账户',
            'el.token_login':     'Token 登录',
            ...
            'reg.email':          '电子邮箱',
            'reg.email_ph':       'you@example.com',
            'reg.display_name':   '显示名称（可选）',
            'reg.name_ph':        '您的名字',
            'reg.password':       '密码',
            'reg.password_hint':  '（至少 8 个字符）',
            'reg.password_ph':    '输入密码',
            'reg.submit':         '创建账户',
            'reg.sign_in':        '登录',
            'reg.free_includes':  '免费注册账户包括：',
            'reg.free_chat':      'AI 对话：每天 5 次',
            'reg.free_kb':        '访问知识库查看器',
            'reg.free_db':        '完整数据库浏览',
            'reg.view_upgrade':   '查看升级选项 →',
            ...
            'prof.name':             '名称：',
            'prof.role':             '角色：',
            'prof.member_since':     '注册时间：',
            'prof.last_login':       '上次登录：',
            'prof.quota_title':      'AI 对话配额',
            'prof.queries_remaining':'今日剩余查询次数',
            'prof.upgrade_btn':      '↑ 升级为 100次/天',
            'prof.recent_activity':  '最近活动',
            'prof.no_activity':      '暂无最近活动。',
            'prof.token_account':    'Token 账户',
            'prof.subject':          '主题：',
            'prof.group':            '组：',

            // Upgrade page
            'upg.title':                 '会员方案',
            'upg.subtitle':              '选择适合您的方案。随时升级以解锁更多 AI 查询和高级功能。',
            'upg.free':                  '免费',
            'upg.per_month':             '/ 月',
            'upg.feat_homepage':         '查看首页和数据库',
            'upg.feat_file_detail':      '文件详情查看',
            'upg.feat_chat_5':           'AI 对话：每天 5 次',
            'upg.feat_kb_viewer':        '知识库查看器',
            'upg.feat_no_task':          '任务管理',
            'upg.feat_no_upload':        '文件上传和编辑',
            'upg.feat_no_priority':      '优先支持',
            'upg.get_started':           '免费开始',
            'upg.current_plan':          '当前方案',
            'upg.most_popular':          '最受欢迎',
            'upg.premium':               '高级版',
            'upg.feat_everything_free':  '包含免费版所有功能',
            'upg.feat_chat_100':         'AI 对话：每天 100 次',
            'upg.feat_full_kb':          '完整知识库访问',
            'upg.feat_download':         '文件下载',
            'upg.feat_priority':         '优先支持',
            'upg.feat_no_config':        '系统配置',
            'upg.upgrade_premium':       '升级到高级版',
            'upg.enterprise':            '企业版',
            'upg.custom_price':          '定制',
            'upg.feat_everything_premium':'包含高级版所有功能',
            'upg.feat_operator':         '运营者访问（任务管理）',
            'upg.feat_upload_config':    '文件上传和配置',
            'upg.feat_dedicated':        '专属支持',
            'upg.feat_custom_quota':     '自定义配额限制',
            'upg.feat_audit_logs':       '审计日志访问',
            'upg.contact_us':            '联系我们',
            'upg.contact_note':          '如需升级，请联系您的管理员或发送邮件。管理员可以在用户管理面板中更改您的角色。',

            // User Management page
            'um.title':               '用户管理',
            'um.search_ph':           '搜索邮箱 / 姓名…',
            'um.all_roles':           '所有角色',
            'um.filter':              '筛选',
            'um.reset':               '重置',
            'um.col_id':              'ID',
            ...
            'um.col_status':          '状态',
            'um.col_joined':          '注册时间',
            'um.col_last_login':      '最后登录',
            'um.col_actions':         '操作',
            'um.active':              '活跃',
            'um.disabled':            '已禁用',
            'um.btn_role':            '角色',
            'um.btn_reset_quota':     '重置配额',
            'um.btn_disable':         '禁用',
            'um.btn_enable':          '启用',
            'um.btn_log':             '日志',
            'um.no_users':            '未找到用户。',
            'um.user_found':          '找到 1 个用户',
            'um.users_found':         '找到 {n} 个用户',
            'um.change_role':         '更改角色',
            'um.save':                '保存',
            'um.cancel':              '取消',
            'um.close':               '关闭',
            'um.activity_log':        '活动日志',
            'um.activity_for':        '活动记录：{email}',
            'um.loading':             '加载中…',
            'um.no_activity':         '无活动记录。',
            'um.activity_load_fail':  '加载活动记录失败。',
            'um.confirm_reset_quota': '确定重置该用户今日的 AI 聊天配额？',
            'um.quota_reset_ok':      '配额已成功重置。',
            'um.confirm_toggle_active': '确定要{action}该用户吗？',
            'um.error_prefix':        '错误：',
            'um.request_failed':      '请求失败：',
            ...
            'cp.model_auto_inherit': 'Token 模型固定为 gpt-4（仅用于 Token 计数）',
            'cp.splitter':      '分割器',
            ...
            'tasks.catalog_ai_config_info': 'AI 模型在设置 → AI 配置中设定',
            ...
            'fv.output_language': '输出语言',
            'fv.lang_auto':      '自动（匹配文档语言）',
            'fv.lang_en':        'English（英文）',
            'fv.lang_zh':        '中文',
            'fv.fh_output_language': '生成摘要、关键词和建议标题的语言。',
            'fv.update_title':   '使用 AI 建议的标题更新文件标题',
            'fv.fh_update_title': '勾选后，编目完成时文件标题将被 AI 生成的建议标题替换。',
            'fv.overwrite_recompute':'覆盖现有内容（重新计算）',
            'fv.overwrite_hint': '不勾选 = 跳过已分类项目',
            'fv.ai_provider':    'AI 供应商',
            'fv.catalog_ai_config_info': 'AI 模型在设置 → AI 配置中设定',
            ...
            'tasks.output_language':   '输出语言',
            'tasks.lang_auto':         '自动（匹配文档语言）',
            'tasks.lang_en':           'English（英文）',
            'tasks.lang_zh':           '中文',
            'tasks.fh_output_language': '生成摘要、关键词和建议标题的语言。',
            'tasks.update_title':      '使用 AI 建议的标题更新文件标题',
            'tasks.fh_update_title':   '勾选后，编目完成时文件标题将被 AI 生成的建议标题替换。',
