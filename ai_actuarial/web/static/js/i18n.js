...
(function (global) {
    ...
    const translations = {
        en: {
            ...
            'stg.ai_filter_kw_help':   'Used to decide whether a document is AI-related (e.g. in AI-only flows).',
            'stg.ai_kw_label':         'ai_filter_keywords (one per line)',
            'stg.model_providers':     'Model Providers',
            'stg.model_providers_help':'Add API keys for LLM providers.',
        ...
        zh: {
            ...
            'stg.ai_filter_kw_help':   '用于判断文档是否与 AI 相关（如在仅 AI 流程中）。',
            'stg.ai_kw_label':         'ai_filter_keywords（每行一个）',
            'stg.model_providers':     '模型供应商',
            'stg.model_providers_help':'添加 LLM 供应商的 API 密钥。',
