...
class ConversationManager:
    ...
    def add_message(
        ...
        if role not in ["user", "assistant"]:
            raise ConversationException(f"Invalid role '{role}'. Must be 'user' or 'assistant'")

        # Check conversation exists
        if not self.get_conversation(conversation_id):
            raise ConversationException(f"Conversation '{conversation_id}' not found")
        ...
        try:
            ...
            logger.info(f"Added {role} message {message_id} to conversation {conversation_id}")
    ...
    def get_messages(
        self, conversation_id: str, limit: Optional[int] = None, include_metadata: bool = False
    ) -> List[Dict[str, Any]]:
        """
    ...
    def get_conversation_stats(self, conversation_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            stats = {"user_messages": 0, "assistant_messages": 0, "total_tokens": 0}
